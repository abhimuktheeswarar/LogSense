...
|---|---|---|
| **Android** (Compose, minSdk per library manifest) | [android/README.md](android/README.md) | `debugImplementation("com.msabhi:logsense:0.6.1")` + `releaseImplementation("com.msabhi:logsense-no-op:0.6.1")` |
