...
internal object LogSenseIcons {
    ...
    val Database = icon(
        "Database",
        "M12,2C6.48,2 2,4 2,6.5v11C2,20 6.48,22 12,22s10,-2 10,-4.5v-11C22,4 17.52,2 12,2zM20,17.5c0,0.71 " +
            "-3.05,2.5 -8,2.5s-8,-1.79 -8,-2.5v-2.62C5.82,15.86 8.72,16.5 12,16.5s6.18,-0.64 8,-1.62V17.5z",
    )
    ...
    val Lock = icon(
        "Lock",
        "M18,8h-1V6c0,-2.76 -2.24,-5 -5,-5S7,3.24 7,6v2H6c-1.1,0 -2,0.9 -2,2v10c0,1.1 0.9,2 2,2h12c1.1,0 " +
            "2,-0.9 2,-2V10c0,-1.1 -0.9,-2 -2,-2zM9,6c0,-1.66 1.34,-3 3,-3s3,1.34 3,3v2H9V6z",
    )
    ...
    val Save = icon(
        "Save",
        "M17,3H5c-1.11,0 -2,0.9 -2,2v14c0,1.1 0.89,2 2,2h14c1.1,0 2,-0.9 2,-2V7l-4,-4zM12,19c-1.66,0 -3,-1.34 " +
            "-3,-3s1.34,-3 3,-3 3,1.34 3,3 -1.34,3 -3,3zM15,9H5V5h10v4z",
    )
