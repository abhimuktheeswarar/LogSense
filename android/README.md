...
Looking for iOS? See [LogSense for Apple platforms](../apple/README.md).
...
// build.gradle.kts
dependencies {
    debugImplementation("com.msabhi:logsense:0.6.3")
    releaseImplementation("com.msabhi:logsense-no-op:0.6.3")
}
```
